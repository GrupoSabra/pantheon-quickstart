...
mkdir -p rsk/data1/privateState
mkdir -p rsk/data1/database
mkdir -p rsk/data1/private

mkdir -p rsk/data2/privateState
mkdir -p rsk/data2/database
mkdir -p rsk/data2/private

mkdir -p rsk/data3/privateState
mkdir -p rsk/data3/database
mkdir -p rsk/data3/private
