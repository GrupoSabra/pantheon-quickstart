...
{
  echo "${bold}*************************"
  echo "RSK Quickstart usage"
  echo "*************************${normal}"
  echo "This script creates and start a local private RSK network using Docker."
...
# value to use for ibft2 option as required for RSK --rpc-http-api and --rpc-ws-api
...
echo "${bold}*************************************"
echo "RSK Quickstart ${QUICKSTART_VERSION}"
echo "*************************************${normal}"
echo "Start network"
echo "--------------------"
